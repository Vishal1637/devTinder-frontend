...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white border-t border-white/10 mt-auto">
      <div className="max-w-6xl mx-auto px-6 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <DevTinderLogo size="md" animated={true} />
            <div>
              <p className="font-bold text-sm bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="p-2 rounded-full bg-blue-500/20 hover:bg-blue-500/40 transition-all duration-300 hover:scale-110"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full bg-blue-600/20 hover:bg-blue-600/40 transition-all duration-300 hover:scale-110"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" className="fill-current text-blue-500">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 rounded-full bg-gray-700/20 hover:bg-gray-700/40 transition-all duration-300 hover:scale-110"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" className="fill-current text-gray-300">
